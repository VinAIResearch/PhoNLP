    ...
    for epoch in range(args['num_epoch']):
        ...
        for i, batch_pos in pbar:
            ...
            loss, loss_pos, loss_ner, loss_dep = trainer.update(
                batch_dep, batch_pos, batch_ner, lambda_pos=lambda_pos, lambda_dep=lambda_dep, lambda_ner=lambda_ner)  # update step
            train_loss += loss
...
def evaluate(args):
    ...
    test_doc_dep = Document(
        CoNLL.conll2dict(input_file=args['eval_file_dep']))
